...
def home(request):
    ...
    # takes Room from models and gives us all the rooms relevant to the query string parameter q. icontains for partial match
...
def createRoom(request):
    ...
    if request.method == 'POST':
        ...
        topic, created = Topic.objects.get_or_create(name=topic_name) # either post to the existing topic or create a new one
